...
export const BackgroundBeams = React.memo(
  ({ className }: { className?: string }) => {
    ...
    return (
      <div className={cn("h-full w-full rounded-md bg-transparent relative flex flex-col items-center justify-center antialiased", className)}>
        <div className="max-w-2xl mx-auto p-4">
          <div className="relative z-10 text-center">
            <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-500 rounded-lg blur-3xl opacity-10"></div>
          </div>
        </div>
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop offset="0.0666667" stopColor="#fbbf24"></stop>
                <stop offset="0.243243" stopColor="#f59e0b"></stop>
                <stop offset="0.43594" stopColor="#d97706" stopOpacity="0"></stop>
              </radialGradient>
            </defs>
          </svg>
        </div>
